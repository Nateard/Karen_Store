...
namespace Karen_Store.Persistence.Migrations
{
    ...
    [Migration("20250223180456_orders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Karen_Store.Domain.Entities.Finance.RequestPay", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Karen_Store.Domain.Entities.Orders.Order", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Karen_Store.Domain.Entities.Orders.OrderDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Karen_Store.Domain.Entities.Orders.Order", b =>
                {
                    b.HasOne("Karen_Store.Domain.Entities.Finance.RequestPay", "RequestPay")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Karen_Store.Domain.Entities.Orders.OrderDetail", b =>
                {
                    b.HasOne("Karen_Store.Domain.Entities.Orders.Order", "Order")
                        .WithMany()
